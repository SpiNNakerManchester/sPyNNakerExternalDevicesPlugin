...
project = u'sPyNNakerExternalDevicesPlugin'
...
htmlhelp_basename = 'sPyNNakerExternalDevicesPlugindoc'
...
latex_documents = [
  ('index', 'sPyNNakerExternalDevicesPlugin.tex',
   u'sPyNNakerExternalDevicesPlugin Documentation', u'', 'manual'),
]
...
man_pages = [
    ('index', 'sPyNNakerExternalDevicesPlugin',
     u'sPyNNakerExternalDevicesPlugin Documentation',
     [u''], 1)
]
...
texinfo_documents = [
  ('index', 'sPyNNakerExternalDevicesPlugin',
   u'sPyNNakerExternalDevicesPlugin Documentation', u'',
   'sPyNNakerExternalDevicesPlugin', '', 'Miscellaneous'),
]
...
epub_title = u'sPyNNakerExternalDevicesPlugin'
epub_author = u''
epub_publisher = u''
